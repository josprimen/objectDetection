...
#El código de estas funciones puede encontrarse en https://raw.githubusercontent.com/experiencor/keras-yolo3/master/yolo3_one_file_to_detect_them_all.py
...
#Descargar e incluir en el proyecto https://pjreddie.com/media/files/yolov3.weights
#Cargamos los pesos pre-entrenados
weight_reader = WeightReader('yolov3.weights')

#cargamos los pesos en nuestro modelo
